        ...
        <!-- <script type="text/javascript">
            $(document).ready(function(){
                $("#cases").click(function(p){
                    ...
                    var q = "?rquest=viewCases&category=foetusabandonedbaby&id=2";
                ...
                $("#add").click(function(){
                    ...
                    var query = new FormData();
                    query.append("rquest","addCase");
                    query.append("category","foetusabandonedbaby");
                    query.append("caseData",JSON.stringify(postData));
                ...
                $("#add").click(function(){
                    ...
                    var postData = {
                        object:[{
                            ...
                            aviationOutsideType: "Commercial aircraft, Light aircraft, Helicopter",
                            aircraftType: "yes",
                            aircraftNumPeople: "6",
                    ...
                    var query = new FormData();
                    query.append("rquest","addCase");
                    query.append("category","aviation");
                    query.append("caseData",JSON.stringify(postData));
