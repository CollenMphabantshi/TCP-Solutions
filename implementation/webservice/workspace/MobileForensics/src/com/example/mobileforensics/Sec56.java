...
public class Sec56 extends Activity implements GlobalMethods, OnMyLocationChangeListener{
	...
	private EditText drSurname;
	private EditText drCell;
	private EditText nurseName;
	private EditText nurseSurname;
	private EditText nurseCell;	
	...
	private RadioButton medicalRecords;	
	private EditText medicalStaffInfo;	
	...
	private void variablesInitialization(){
		...
		ioName = (EditText)findViewById(R.id.sect48_io_name);		
		ioSurname = (EditText)findViewById(R.id.sect48_io_surname);		
		ioRank = (EditText)findViewById(R.id.sect48_io_rank);		
		ioCellNo = (EditText)findViewById(R.id.sect48_io_cell);
	
		
		
		victimName = (EditText)findViewById(R.id.sect48_victim_name);
		victimSurname = (EditText)findViewById(R.id.sect48_victim_surname);
		victimIDNo = (EditText)findViewById(R.id.sect48_victim_id);
		victimAge = (EditText)findViewById(R.id.sect48_victim_age);
		
		rgbMale = (RadioButton)findViewById(R.id.sect48_rgbMale);
		rgbFemale = (RadioButton)findViewById(R.id.sect48_rgbFemale);
		rgbUnknownGender = (RadioButton)findViewById(R.id.sect48_rgbUnknownGender);
		
		rgbAsian = (RadioButton)findViewById(R.id.sect48_rgbAsian);
		rgbBlack = (RadioButton)findViewById(R.id.sect48_rgbBlack);
		rgbColoured = (RadioButton)findViewById(R.id.sect48_rgbColoured);
		rgbWhite = (RadioButton)findViewById(R.id.sect48_rgbWhite);
		rgbUnknownRace = (RadioButton)findViewById(R.id.sect48_rgbUnknownRace);
		
		drName = (EditText)findViewById(R.id.sect48_drname);
		drSurname = (EditText)findViewById(R.id.sect48_drsurname);
		drCell = (EditText)findViewById(R.id.sect48_drcell);
		nurseName = (EditText)findViewById(R.id.sect48_sisname);
		nurseSurname = (EditText)findViewById(R.id.sect48_sissurname);
		nurseCell = (EditText)findViewById(R.id.sect48_siscell);
		...
		medicalRecords = (RadioButton)findViewById(R.id.sect48_medicalRecordsYes);
		medicalStaffInfo = (EditText)findViewById(R.id.sect48_medicalStuff);
		

		
		generalHistory = (EditText)findViewById(R.id.sect48_generalHistory);
		
		
		response = (TextView)findViewById(R.id.sect48_tv_response);
		
		doneButton = (Button)findViewById(R.id.sect48_doneButton);
		logoutButton = (Button)findViewById(R.id.sect48_logoutButton);
		...
		//upload pictures part
	       ...
	       Gallery = (LinearLayout) findViewById(R.id.sect48_galleryLayout);
	       // weather section
...
public void readAllFiles(){
    	...
    	for (int i=0; i < files.length; i++)
    	{
        	...
        	//{
    		Toast.makeText(Sec56.this, "Image: "+path+files[i].getName(), Toast.LENGTH_SHORT).show();
   ...
   public String getExtesion(String filename){
				...
				try{
					...
					if(postdata != null)
					{
						if(ValidateFields()){
							...
							Toast.makeText(Sec56.this, "Sorry fields must be filled", Toast.LENGTH_SHORT).show();
						}
	               ...
	               try { 
	                   ...
	                   if(serverResponseCode == 200){
	                       ...
	                       runOnUiThread(new Runnable() {
	                            public void run() {
	                                ...
	                                Toast.makeText(Sec56.this, "File Upload Complete.", 
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Sec56.this, "MalformedURLException", 
	                                                              Toast.LENGTH_SHORT).show();
	                      }
	                  });
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Sec56.this, "Got Exception : see logcat ", 
	                                  Toast.LENGTH_SHORT).show();
	                      }
	                  });
	...
	public List<NameValuePair> getPostData(){
		try{
	        ...
	        pairs.add(new BasicNameValuePair("category",Encryption.bytesToHex(enc.encrypt("section48"))));
	        ...
	        info.accumulate("firstOfficerOnSceneName", Encryption.bytesToHex(enc.encrypt("null")));
	        info.accumulate("firstOfficerOnSceneRank", Encryption.bytesToHex(enc.encrypt("null")));
	        knownVictim();
	      ...
	      //this is part where am getting all images
			...
			info.accumulate("NurseCellNumber", Encryption.bytesToHex(enc.encrypt(nurseCell.getText().toString())));
	      ...
	      //the body
			 ...
			 if(GW.isChecked()){
				 info.accumulate("gw7_24file", Encryption.bytesToHex(enc.encrypt("Yes"))); 
			 }else{
				 info.accumulate("gw7_24file", Encryption.bytesToHex(enc.encrypt("No")));
			 }
			
			  if(GWCompleted.isChecked()){
				  info.accumulate("gw7_24fileFullyComplete", Encryption.bytesToHex(enc.encrypt("Yes")));
			  }else{
				  info.accumulate("gw7_24fileFullyComplete", Encryption.bytesToHex(enc.encrypt("No")));
			  }
			 
			 
			 if(medicalRecords .isChecked())
		        {
		        	info.accumulate("medicalRecords", Encryption.bytesToHex(enc.encrypt("Yes")));
		        }else{
		        	info.accumulate("medicalRecords", Encryption.bytesToHex(enc.encrypt("No")));
		        }
