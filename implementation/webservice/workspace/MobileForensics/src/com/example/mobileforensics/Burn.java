...
public class Burn extends Activity implements GlobalMethods, OnMyLocationChangeListener{
	...
	private TextView tv_wasBodyHospitilized;
	private RadioButton wasBodyHospitilizedYes;
	private RadioButton wasBodyHospitilizedNo;
	private TextView tv_bodyCharred;
	private RadioButton bodyCharredYes;
	private RadioButton bodyCharredNo;
	private TextView tv_howBurnWoundsSustained;
	private EditText howBurnWoundsSustained;
	...
	private TextView tv_buildingDamaged;
	private Spinner buildingDamaged;
	...
	private TextView tv_anyPotentialWeapons;
	private RadioButton anyPotentialWeaponsYes;
	private RadioButton anyPotentialWeaponsNo;
	...
	private TextView tv_foulPlaySuspected;
	private RadioButton foulPlaySuspectedYes;
	private RadioButton foulPlaySuspectedNo;
	private TextView tv_accelerantsAtScene;
	private RadioButton accelerantsAtSceneYes;
	private RadioButton accelerantsAtSceneNo;
	private TextView tv_igniterAtScene;
	private RadioButton igniterAtSceneYes;
	private RadioButton igniterAtSceneNo;
	private TextView tv_wierdSmell;
	private RadioButton wierdSmellYes;
	private RadioButton wierdSmellNo;
	...
	private File createImageFile() throws IOException{
	    ...
	    String imageFileName = "Burns_" + timeStamp + "_";
	...
	private void setPic(ImageView mImageView){
	    ...
	    String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
	    try {
			uploadFileName.add(convertImageToString(mCurrentPhotoPath,"Burns_" + timeStamp+".jpg"));
		} catch (IOException e) {
	...
	private void variablesInitialization(){
		...
		ioName = (EditText)findViewById(R.id.burn_io_name);
		
		ioSurname = (EditText)findViewById(R.id.burn_io_surname);
		
		ioRank = (EditText)findViewById(R.id.burn_io_rank);
		
		ioCellNo = (EditText)findViewById(R.id.burn_io_cell);
		
		tv_foosName = (TextView)findViewById(R.id.burn_tv_foos_name);
		foosName = (EditText)findViewById(R.id.burn_foos_name);
		tv_foosSurname = (TextView)findViewById(R.id.burn_tv_foos_surname);
		foosSurname = (EditText)findViewById(R.id.burn_foos_surname);
		tv_foosRank = (TextView)findViewById(R.id.burn_tv_foos_rank);
		foosRank = (EditText)findViewById(R.id.burn_foos_rank);
		
	
		
		tv_victimName = (TextView)findViewById(R.id.burn_tv_victim_name);
		victimName = (EditText)findViewById(R.id.burn_victim_name);
		tv_victimSurname = (TextView)findViewById(R.id.burn_tv_victim_surname);
		victimSurname = (EditText)findViewById(R.id.burn_victim_surname);
		tv_victimIDNo = (TextView)findViewById(R.id.burn_tv_victim_id);
		victimIDNo = (EditText)findViewById(R.id.burn_victim_id);
		victimAge = (EditText)findViewById(R.id.burn_victim_age);
		
		rgbMale = (RadioButton)findViewById(R.id.burn_rgbMale);
		rgbFemale = (RadioButton)findViewById(R.id.burn_rgbFemale);
		rgbUnknownGender = (RadioButton)findViewById(R.id.burn_rgbUnknownGender);
		
		rgbAsian = (RadioButton)findViewById(R.id.burn_rgbAsian);
		rgbBlack = (RadioButton)findViewById(R.id.burn_rgbBlack);
		rgbColoured = (RadioButton)findViewById(R.id.burn_rgbColoured);
		rgbWhite = (RadioButton)findViewById(R.id.burn_rgbWhite);
		rgbUnknownRace = (RadioButton)findViewById(R.id.burn_rgbUnknownRace);
		
		
		theBody = (TextView)findViewById(R.id.burn_tv_the_body);
		tv_bodyDecomposed = (TextView)findViewById(R.id.burn_tv_bodyDecomposed);
		bodyDecomposedYes = (RadioButton)findViewById(R.id.burn_bodyDecomposedYes);
		bodyDecomposedNo = (RadioButton)findViewById(R.id.burn_bodyDecomposedNo);
		tv_medicalIntervention = (TextView)findViewById(R.id.burn_tv_medicalIntervention);
		medicalInterventionYes = (RadioButton)findViewById(R.id.burn_medicalInterventionYes);
		medicalInterventionNo = (RadioButton)findViewById(R.id.burn_medicalInterventionNo);
		tv_whoFoundVictimBody = (TextView)findViewById(R.id.burn_tv_whoFoundVictimBody);
		whoFoundVictimBody = (EditText)findViewById(R.id.burn_whoFoundVictimBody);
		tv_closeToWater = (TextView)findViewById(R.id.burn_tv_closeToWater);
		closeToWaterYes = (RadioButton)findViewById(R.id.burn_closeToWaterYes);
		closeToWaterNo = (RadioButton)findViewById(R.id.burn_closeToWaterNo);
		tv_rapeHomicide = (TextView)findViewById(R.id.burn_tv_rapeHomicide);
		rapeHomicideYes = (RadioButton)findViewById(R.id.burn_rapeHomicideYes);
		rapeHomicideNo = (RadioButton)findViewById(R.id.burn_rapeHomicideNo);
		tv_suicideSuspected = (TextView)findViewById(R.id.burn_tv_suicideSuspected);
		suicideSuspectedYes = (RadioButton)findViewById(R.id.burn_suicideSuspectedYes);
		suicideSuspectedNo = (RadioButton)findViewById(R.id.burn_suicideSuspectedNo);
		tv_previousAttempts = (TextView)findViewById(R.id.burn_tv_previousAttempts);
		previousAttemptsYes = (RadioButton)findViewById(R.id.burn_previousAttemptsYes);
		previousAttemptsNo = (RadioButton)findViewById(R.id.burn_previousAttemptsNo);
		tv_howManyAttempts = (TextView)findViewById(R.id.burn_tv_howManyAttempts);
		howManyAttempts = (EditText)findViewById(R.id.burn_howManyAttempts);
		tv_wasBodyHospitilized = (TextView)findViewById(R.id.burn_tv_wasBodyHospitilized);
		wasBodyHospitilizedYes = (RadioButton)findViewById(R.id.burn_wasBodyHospitilizedYes);
		wasBodyHospitilizedNo = (RadioButton)findViewById(R.id.burn_wasBodyHospitilizedNo);
		tv_howBurnWoundsSustained = (TextView)findViewById(R.id.burn_tv_howBurnWoundsSustained);
		howBurnWoundsSustained = (EditText)findViewById(R.id.burn_howBurnWoundsSustained);
		tv_bodyCharred = (TextView)findViewById(R.id.burn_tv_bodyCharred);
		bodyCharredYes = (RadioButton)findViewById(R.id.burn_bodyCharredYes);
		bodyCharredNo = (RadioButton)findViewById(R.id.burn_bodyCharredNo);
		
		sceneOfInjury = (TextView)findViewById(R.id.burn_sceneOfInjury);
		tv_sceneIOType = (TextView)findViewById(R.id.burn_tv_sceneIOType);
		sceneIOTypeInside = (RadioButton)findViewById(R.id.burn_SceneIOTypeInside);
		sceneIOTypeOutside = (RadioButton)findViewById(R.id.burn_SceneIOTypeOutside);
		tv_whereInside = (TextView)findViewById(R.id.burn_tv_whereInside);
		sceneIType = (Spinner)findViewById(R.id.burn_sceneIType);
		tv_sceneITypeOther = (TextView)findViewById(R.id.burn_tv_sceneITypeOther);
		sceneITypeOther = (EditText)findViewById(R.id.burn_sceneITypeOther);
		buildingDamaged = (Spinner)findViewById(R.id.burn_buildingDamaged);
		tv_doorLocked = (TextView)findViewById(R.id.burn_tv_doorLocked);
		doorLockedYes = (RadioButton)findViewById(R.id.burn_DoorLockedYes);
		doorLockedNo = (RadioButton)findViewById(R.id.burn_DoorLockedNo);
		tv_windowsClosed = (TextView)findViewById(R.id.burn_tv_windowsClosed);
		windowsClosedYes = (RadioButton)findViewById(R.id.burn_WindowsClosedYes);
		windowsClosedNo = (RadioButton)findViewById(R.id.burn_WindowsClosedNo);
		tv_windowsBroken = (TextView)findViewById(R.id.burn_tv_windowsBroken);
		windowsBrokenYes = (RadioButton)findViewById(R.id.burn_WindowsBrokenYes);
		windowsBrokenNo = (RadioButton)findViewById(R.id.burn_WindowsBrokenNo);
		tv_victimAlone = (TextView)findViewById(R.id.burn_tv_victimAlone);
		victimAloneYes = (RadioButton)findViewById(R.id.burn_VictimAloneYes);
		victimAloneNo = (RadioButton)findViewById(R.id.burn_VictimAloneNo);
		tv_peopleWithVictim = (TextView)findViewById(R.id.burn_tv_peopleWithVictim);
		peopleWithVictim = (EditText)findViewById(R.id.burn_peopleWithVictim);
		tv_sceneOType = (TextView)findViewById(R.id.burn_tv_sceneOType);
		sceneOType = (Spinner)findViewById(R.id.burn_sceneOType);
		tv_sceneOTypeOther = (TextView)findViewById(R.id.burn_tv_sceneOTypeOther);
		sceneOTypeOther = (EditText)findViewById(R.id.burn_sceneOTypeOther);
		
		
		sceneLook = (TextView)findViewById(R.id.burn_sceneLook);
		tv_signsOfStruggle = (TextView)findViewById(R.id.burn_tv_signsOfStruggle);
		signsOfStruggleYes = (RadioButton)findViewById(R.id.burn_SignsOfStruggleYes);
		signsOfStruggleNo = (RadioButton)findViewById(R.id.burn_SignsOfStruggleNo);
		tv_alcoholBottleAround = (TextView)findViewById(R.id.burn_tv_alcoholBottleAround);
		alcoholBottleAroundYes = (RadioButton)findViewById(R.id.burn_AlcoholBottleAroundYes);
		alcoholBottleAroundNo = (RadioButton)findViewById(R.id.burn_AlcoholBottleAroundNo);
		tv_drugParaphernalia = (TextView)findViewById(R.id.burn_tv_drugParaphernalia);
		drugParaphernaliaYes = (RadioButton)findViewById(R.id.burn_DrugParaphernaliaYes);
		drugParaphernaliaNo = (RadioButton)findViewById(R.id.burn_DrugParaphernaliaNo);
		tv_anyPotentialWeapons = (TextView)findViewById(R.id.burn_tv_anyPotentialWeapons);
		anyPotentialWeaponsYes = (RadioButton)findViewById(R.id.burn_anyPotentialWeaponsYes);
		...
		tv_accelerantsAtScene = (TextView)findViewById(R.id.burn_tv_accelerantsAtScene);
		accelerantsAtSceneYes = (RadioButton)findViewById(R.id.burn_accelerantsAtSceneYes);
		accelerantsAtSceneNo = (RadioButton)findViewById(R.id.burn_accelerantsAtSceneNo);
		tv_igniterAtScene = (TextView)findViewById(R.id.burn_tv_igniterAtScene);
		igniterAtSceneYes = (RadioButton)findViewById(R.id.burn_igniterAtSceneYes);
		igniterAtSceneNo = (RadioButton)findViewById(R.id.burn_igniterAtSceneNo);
		tv_wierdSmell = (TextView)findViewById(R.id.burn_tv_wierdSmell);
		wierdSmellYes = (RadioButton)findViewById(R.id.burn_wierdSmellYes);
		wierdSmellNo = (RadioButton)findViewById(R.id.burn_wierdSmellNo);
		tv_suicideNoteFound = (TextView)findViewById(R.id.burn_tv_suicideNoteFound);
		suicideNoteFoundYes = (RadioButton)findViewById(R.id.burn_SuicideNoteFoundYes);
		suicideNoteFoundNo = (RadioButton)findViewById(R.id.burn_SuicideNoteFoundNo);
		tv_generalHistory = (TextView)findViewById(R.id.burn_tv_generalHistory);
		generalHistory = (EditText)findViewById(R.id.burn_generalHistory);
		
		
		response = (TextView)findViewById(R.id.burn_tv_response);
		
		doneButton = (Button)findViewById(R.id.burn_doneButton);
		logoutButton = (Button)findViewById(R.id.burn_logoutButton);
		
		BackToMenu = (Button)findViewById(R.id.burn_BackToMenu);
				...
				try{
					...
					if(postdata != null)
					{
						if(ValidateFields()){
							...
							Toast.makeText(Burn.this, "Sorry fields must be filled", Toast.LENGTH_SHORT).show();
						}
	               ...
	               try { 
	                   ...
	                   if(serverResponseCode == 200){
	                       ...
	                       runOnUiThread(new Runnable() {
	                            public void run() {
	                                ...
	                                Toast.makeText(Burn.this, "File Upload Complete.", 
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Burn.this, "MalformedURLException", 
	                                                              Toast.LENGTH_SHORT).show();
	                      }
	                  });
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Burn.this, "Got Exception : see logcat ", 
	                                  Toast.LENGTH_SHORT).show();
	                      }
	                  });
	...
	public List<NameValuePair> getPostData(){
		try{
	      ...
	      //this is part where am getting all images
	        ...
	        if(accelerantsAtSceneYes.isChecked())
	        {
	        	info.accumulate("accelerantsAtScene", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("accelerantsAtScene", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(igniterAtSceneYes.isChecked())
	        {
	        	info.accumulate("igniterAtScene", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("igniterAtScene", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(wierdSmellYes.isChecked())
	        {
	        	info.accumulate("wierdSmell", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("wierdSmell", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        String bd = (String)buildingDamaged.getSelectedItem();
	        info.accumulate("buildingDamaged", Encryption.bytesToHex(enc.encrypt(bd)));
	        ...
	        if(anyPotentialWeaponsYes.isChecked())
	        {
	        	info.accumulate("anyPotentialWeapons", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("anyPotentialWeapons", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(foulPlaySuspectedYes.isChecked())
	        {
	        	info.accumulate("foulPlaySuspected", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("foulPlaySuspected", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(bodyCharredYes.isChecked())
	        {
	        	info.accumulate("bodyCharred", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("bodyCharred", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	...
	public void saveDataOnAction() throws Exception{
        ...
        info.accumulate("burnIOType",getIOType() );
        if(signsOfStruggleYes.isChecked())
        {
        	info.accumulate("signsOfStruggle", Encryption.bytesToHex(enc.encrypt("Yes")));
        }else{
	...
	private boolean ValidateFields(){
		...
		if( victimAge.getText().toString().length() == 0){
			...
			victimAge.setError("sorry empty field");
			return false;
		}
		
		try{
			int tmp = Integer.parseInt(victimAge.getText().toString());
		}catch(Exception e){
			victimAge.requestFocus();
			victimAge.setError("Sorry only numeric value allowed");
			return false;
		}
	...
	private void CheckRadioButtons(){
		...
		foulPlaySuspectedNo.setChecked(true);
		bodyCharredNo.setChecked(true);
		accelerantsAtSceneNo.setChecked(true);
	
		igniterAtSceneNo.setChecked(true);
