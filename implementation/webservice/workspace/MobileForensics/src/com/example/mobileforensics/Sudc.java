...
public class Sudc extends Activity implements GlobalMethods, OnMyLocationChangeListener{
	...
	private void setPic(ImageView mImageView){
	    ...
	    String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
	    try {
			uploadFileName.add(convertImageToString(mCurrentPhotoPath,"SUDCt_" + timeStamp+".jpg"));
		} catch (IOException e) {
	...
	private void variablesInitialization(){
		...
		windowsBrokenYes = (RadioButton)findViewById(R.id.sudc_doorLockedYes);
		windowsBrokenNo = (RadioButton)findViewById(R.id.sudc_doorLockedNo);
		...
		weirdSmellNo = (RadioButton)findViewById(R.id.sudc_weirdSmellNo);
		...
		strangulationSuspectedYes = (RadioButton)findViewById(R.id.sudc_strangulationSuspectedYes);
		strangulationSuspectedNo = (RadioButton)findViewById(R.id.sudc_strangulationSuspectedNo);
		smotheringSuspectedYes = (RadioButton)findViewById(R.id.sudc_smotheringSuspectedYes);
		smotheringSuspectedNo = (RadioButton)findViewById(R.id.sudc_smotheringSuspectedNo);
		...
		//upload pictures part
	       ...
	       Gallery = (LinearLayout) findViewById(R.id.sudc_galleryLayout);
	       // weather section
	...
	public List<NameValuePair> getPostData(){
		try{
	      ...
	      //this is part where am getting all images
	        ...
	        {
	        	info.accumulate("physicalExercise", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("physicalExercise", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        info.accumulate("familyMembersSufferingFrom", Encryption.bytesToHex(enc.encrypt((String)familySuffering.getSelectedItem())));
	        info.accumulate("familyMembersSuffering", Encryption.bytesToHex(enc.encrypt(specifyWho.getText().toString())));
	        
	        if(victimFellYes.isChecked())
	        {
	        	info.accumulate("victimFell", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("victimFell", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(VictimComplainYes.isChecked())
	        {
	        	info.accumulate("victimComplain", Encryption.bytesToHex(enc.encrypt("Yes")));
	        	info.accumulate("victimComplainSpecified", Encryption.bytesToHex(enc.encrypt(victimComplainYesSpecify.getText().toString())));
	        }else{
	        	info.accumulate("victimComplain", Encryption.bytesToHex(enc.encrypt("No")));
	        	info.accumulate("victimComplainSpecified", Encryption.bytesToHex(enc.encrypt("null")));
	        }
	        
	        if(victimTakeMedicationYes.isChecked())
	        {
	        	info.accumulate("victimTakeMedication", Encryption.bytesToHex(enc.encrypt("Yes")));
	        	info.accumulate("victimTakeMedicationSpecified", Encryption.bytesToHex(enc.encrypt(victimTakeMedicationYesSpecify.getText().toString())));
	        }else{
	        	info.accumulate("victimTakeMedication", Encryption.bytesToHex(enc.encrypt("No")));
	        	info.accumulate("victimTakeMedicationSpecified", Encryption.bytesToHex(enc.encrypt("null")));
	        }
	        ...
	        {
	        	info.accumulate("suspisionOfAssault", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("suspisionOfAssault", Encryption.bytesToHex(enc.encrypt("No")));
	        }
	        
	        if(overdoseYes.isChecked())
	        {
	        	info.accumulate("suspisionOfOverdose", Encryption.bytesToHex(enc.encrypt("Yes")));
	        }else{
	        	info.accumulate("suspisionOfOverdose", Encryption.bytesToHex(enc.encrypt("No")));
	        }
