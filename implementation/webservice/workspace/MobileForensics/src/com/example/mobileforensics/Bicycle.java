...
public class Bicycle extends Activity implements GlobalMethods, OnMyLocationChangeListener{
	...
	private File createImageFile() throws IOException{
	    ...
	    String imageFileName = "bicycle_" + timeStamp + "_";
	...
	private void setPic(ImageView mImageView){
	    ...
	    String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
	    try {
			uploadFileName.add(convertImageToString(mCurrentPhotoPath,"bicycle_" + timeStamp+".jpg"));
		} catch (IOException e) {
	...
	private void variablesInitialization(){
		...
		rgbMale = (RadioButton)findViewById(R.id.bicycle_rgbMale);
		rgbFemale = (RadioButton)findViewById(R.id.bicycle_rgbFemale);
		rgbUnknownGender = (RadioButton)findViewById(R.id.bicycle_rgbUnknownGender);
		
		rgbAsian = (RadioButton)findViewById(R.id.bicycle_rgbAsian);
		rgbBlack = (RadioButton)findViewById(R.id.bicycle_rgbBlack);
		rgbColoured = (RadioButton)findViewById(R.id.bicycle_rgbColoured);
		...
		response = (TextView)findViewById(R.id.bicycle_tv_response);
	               ...
	               try { 
	                   ...
	                   if(serverResponseCode == 200){
	                       ...
	                       runOnUiThread(new Runnable() {
	                            public void run() {
	                                ...
	                                Toast.makeText(Bicycle.this, "File Upload Complete.", 
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Bicycle.this, "MalformedURLException", 
	                                                              Toast.LENGTH_SHORT).show();
	                      }
	                  });
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Bicycle.this, "Got Exception : see logcat ", 
	                                  Toast.LENGTH_SHORT).show();
	                      }
	                  });
