...
public class Mba extends Activity implements GlobalMethods, OnMyLocationChangeListener{
	...
	//the body
	private RadioButton flungRoadSurfaceYes;
	private RadioButton flungRoadSurfacedNo;
	private RadioButton flungBanisterYes;
	private RadioButton flungBanisterNo;
	private RadioButton flungCarYes;
	private RadioButton flungCarNo;
	private RadioButton MBFellOnVictimYes;
	private RadioButton MBFellOnVictimNo;
	...
	private RadioButton wearingProtectiveClothingYes;
	private RadioButton wearingProtectiveClothingNo;
	private RadioButton wearingHelmetYes;
	private RadioButton wearingHelmetNo;
	private RadioButton helmetOnAfterYes;
	private RadioButton helmetOnAfterNo;
	...
	private void setPic(ImageView mImageView){
	    ...
	    String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
	    try {
			uploadFileName.add(convertImageToString(mCurrentPhotoPath,"MBA_" + timeStamp+".jpg"));
		} catch (IOException e) {
	...
	private void variablesInitialization(){
		...
		//the body
		flungRoadSurfaceYes = (RadioButton)findViewById(R.id.mba_flungRoadSurfaceYes);
		flungRoadSurfacedNo = (RadioButton)findViewById(R.id.mba_flungRoadSurfacedNo);
		flungBanisterYes = (RadioButton)findViewById(R.id.mba_flungBanisterYes);
		flungBanisterNo = (RadioButton)findViewById(R.id.mba_flungBanisterNo);
		flungCarYes = (RadioButton)findViewById(R.id.mba_flungCarYes);
		flungCarNo = (RadioButton)findViewById(R.id.mba_flungCarNo);
		MBFellOnVictimYes = (RadioButton)findViewById(R.id.mba_MBFellOnVictimYes);
		MBFellOnVictimNo = (RadioButton)findViewById(R.id.mba_MBFellOnVictimNo);
		EyewitnessesYes = (RadioButton)findViewById(R.id.mba_EyewitnessesYes);
		EyewitnessesNo = (RadioButton)findViewById(R.id.mba_EyewitnessesNo);
		bodyBurntYes = (RadioButton)findViewById(R.id.mba_bodyBurntYes);
		bodyBurntNo = (RadioButton)findViewById(R.id.mba_bodyBurntNo);
		movedSinceAccidentYes = (RadioButton)findViewById(R.id.mba_movedSinceAccidentYes);
		movedSinceAccidentNo = (RadioButton)findViewById(R.id.mba_movedSinceAccidentNo);
		medicalInterventionYes = (RadioButton)findViewById(R.id.mba_medicalInterventionYes);
		medicalInterventionNo = (RadioButton)findViewById(R.id.mba_medicalInterventionNo);
		wearingProtectiveClothingYes = (RadioButton)findViewById(R.id.mba_wearingProtectiveClothingYes);
		wearingProtectiveClothingNo = (RadioButton)findViewById(R.id.mba_wearingProtectiveClothingNo);
		wearingHelmetYes = (RadioButton)findViewById(R.id.mba_wearingHelmetYes);
		wearingHelmetNo = (RadioButton)findViewById(R.id.mba_wearingHelmetNo);
		helmetOnAfterYes = (RadioButton)findViewById(R.id.mba_helmetOnAfterYes);
		helmetOnAfterNo = (RadioButton)findViewById(R.id.mba_helmetOnAfterNo);
		removedBy = (Spinner)findViewById(R.id.mba_removedBy);
		
		
		//Scene of injury
		AccidentOccured = (Spinner)findViewById(R.id.mba_AccidentOccured);
		otherLocation = (EditText) findViewById(R.id.mba_otherLocation);
		
		//The Scene
		singleOrMultipleYes = (RadioButton)findViewById(R.id.mba_singleOrMultipleYes);
		singleOrMultipleNo = (RadioButton)findViewById(R.id.mba_singleOrMultipleNo);
		
		hitFrom = (Spinner)findViewById(R.id.mba_hitFrom);
		accidentType = (Spinner)findViewById(R.id.mba_accidentType);
		weatherType = (Spinner)findViewById(R.id.mba_weatherType);
		weatherCondition = (Spinner)findViewById(R.id.mba_weatherCondition);
...
public void readAllFiles(){
    	...
    	for (int i=0; i < files.length; i++)
    	{
        	...
        	//{
    		Toast.makeText(Mba.this, "Image: "+path+files[i].getName(), Toast.LENGTH_SHORT).show();
   ...
   public String getExtesion(String filename){
				...
				try{
					...
					if(postdata != null)
					{
						if(ValidateFields()){
							...
							Toast.makeText(Mba.this, "Sorry fields must be filled", Toast.LENGTH_SHORT).show();
						}
	               ...
	               try { 
	                   ...
	                   if(serverResponseCode == 200){
	                       ...
	                       runOnUiThread(new Runnable() {
	                            public void run() {
	                                ...
	                                Toast.makeText(Mba.this, "File Upload Complete.", 
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Mba.this, "MalformedURLException", 
	                                                              Toast.LENGTH_SHORT).show();
	                      }
	                  });
	                  ...
	                  runOnUiThread(new Runnable() {
	                      public void run() {
	                          ...
	                          Toast.makeText(Mba.this, "Got Exception : see logcat ", 
	                                  Toast.LENGTH_SHORT).show();
	                      }
	                  });
	...
	public List<NameValuePair> getPostData(){
		try{
	        ...
	        pairs.add(new BasicNameValuePair("category",Encryption.bytesToHex(enc.encrypt("mba"))));
	      ...
	      //this is part where am getting all images
	        ...
	        if(flungRoadSurfaceYes .isChecked())
	        {
	        ...
	        info.accumulate("helmetRemovedBy", Encryption.bytesToHex(enc.encrypt((String)removedBy.getSelectedItem())));
	        
	        
	        if(singleOrMultipleYes .isChecked())
	        {
	        	info.accumulate("victimsOnMotorcycle", Encryption.bytesToHex(enc.encrypt("Single")));
	        }else{
	        	info.accumulate("victimsOnMotorcycle", Encryption.bytesToHex(enc.encrypt("Multiple")));
	        }
	        
	        info.accumulate("motorbikeHitFrom", Encryption.bytesToHex(enc.encrypt((String)hitFrom.getSelectedItem())));
